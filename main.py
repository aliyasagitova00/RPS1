...
class Main(Frame):
    ...
    def startUI(self):
        btn = Button(root, text="Камень", font=("beer money", 15),
                     command=lambda x=1: self.btn_click(x))
        btn2 = Button(root, text="Ножницы", font=("beer money", 15),
                      command=lambda x=2: self.btn_click(x))
        btn3 = Button(root, text="Бумага", font=("beer money", 15),
        ...
        self.lbl = Label(root, text="Начало игры!", bg="#20B2AA", font=("beer money", 21, "bold"))
        self.lbl.place(x=150, y=25)

        self.win = self.drow = self.lose = 0

        self.lbl2 = Label(root, justify="left", font=("beer money", 13),
